 ...
 * @brief This file contains the declaration of the z_bmqa_Session structure
 ...
 * @param options Pointer to the SessionOptions object for configuring the
 * session.
 *
 ...
 *
 * @param session_obj Pointer to the Session object.
 * @param builder Pointer to the ConfirmEventBuilder object containing the
 * messages to confirm.
 *
 * @return Returns 0 upon successful confirmation.
 */
